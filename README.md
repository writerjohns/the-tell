...
Open `The_Tell_v05.ink` in **Inky** and play from the beginning.
...
The current v05 state machine has passed:
...
- `The_Tell_v05.ink` — employer-facing playable Ink source;
- `README.md` — project overview and architecture diagrams;
- `DEV_NOTES.md` — deeper design rationale for code reviewers;
- `qa/The_Tell_v05_QA.ink` — deterministic regression build;
- `qa/QA_Guide.md` — targeted runtime test procedure;
- `qa/regression_matrix.csv` — certified path/outcome reference.
